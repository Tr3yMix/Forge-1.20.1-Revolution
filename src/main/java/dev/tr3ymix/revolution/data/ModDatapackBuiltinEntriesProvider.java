...
import dev.tr3ymix.revolution.registry.ModBiomeModifiers;
import dev.tr3ymix.revolution.registry.ModConfiguredFeatures;
import dev.tr3ymix.revolution.registry.ModPlacedFeatures;
...
public class ModDatapackBuiltinEntriesProvider extends DatapackBuiltinEntriesProvider {
    ...
    public ModDatapackBuiltinEntriesProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Set.of(RevolutionMod.MOD_ID));
    }
}
